...
/*引脚配置*/
#define OLED_W_SCL(x) {GPIO_writePin(OLED_SCL,x);DEVICE_DELAY_NS(100);}
#define OLED_W_SDA(x) {GPIO_writePin(OLED_SDA,x);DEVICE_DELAY_NS(100);}
#define OLED_ADRR (0x78)
...
{
    OLED_I2C_Start();
    OLED_I2C_SendByte(OLED_ADRR); //从机地址
